...
enum SbError {
  ...
  String get message => switch (this) {
        ...
        libraryMissing => 'libsoundboard_keys.so was not found in the bundle.',
      };
}
...
class GlobalKeyboard {
  ...
  String? _resolveLibrary() {
    ...
    for (final candidate in [
      '$exeDir/lib/libsoundboard_keys.so',
      '$exeDir/libsoundboard_keys.so',
      'build/linux/x64/debug/bundle/lib/libsoundboard_keys.so',
      'build/linux/x64/release/bundle/lib/libsoundboard_keys.so',
    ]) {
